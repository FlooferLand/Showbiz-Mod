package com.flooferland.showbiz.client.entity.renderer;
...
import static com.flooferland.showbiz.backend.block.custom.ShowSelectorBlock.ALWAYS_SHOW_INTERACTION_LABELS;
