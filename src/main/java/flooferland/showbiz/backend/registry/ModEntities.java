...
import flooferland.showbiz.client.entity.renderer.InteractPartEntityRenderer;
...
public class ModEntities {
    ...
    public static void registerClientEntities() {
        ...
        // EntityRendererRegistry.register(PLACEHOLDER_ENTITY, EmptyEntityRenderer::new);
